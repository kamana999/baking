				  ...
				  <div class="card-body p-4">
					  ...
					  <hr/>
                        <div class="form-body mt-4">
                            ...
                            <form action="{{route('vendors.update',$edits->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="mb-3">
                                    <label for="">User_Id<span class="text-danger"> * </span></label>
                                    <select name="user_id" id="" class="form-control" value="{{$edits->user_id}}">
                                        @foreach ($users as $c)
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="street" class="form-control" value="{{$edits->street}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="country_id" id="" class="form-control" value="{{$edits->country_id}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="state_id" id="" class="form-control" value="{{$edits->state_id}}">
                                        @foreach ($state as $c)
                                            <option value="{{$c->id}}">{{$c->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="area_id" id="" class="form-control" value="{{$edits->area_id}}">
                                        @foreach ($area as $c)
                                            <option value="{{$c->id}}">{{$c->name}}</option>
                                        @endforeach
                                    </select>

                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <h6 class="text-muted">Message- {{$oi->message}}</h6>
                                <h6 class="text-muted">Delivery Date- {{$oi->delivery_date}}</h6>
                                <h6 class="text-muted">Delivery Time- {{$oi->delivery_time}}</h6>
                                    @if($oi->cake->discount_price)
                                    <h6 class="text-muted">Price per unit = {{$oi->cake->discount_price}} <del>{{$oi->cake->price}}</del></h6>
                                    @else
                                    <h6>Price per unit = {{$oi->cake->price}} </h6>
                                    @endif
                                
                                @if($oi->cake->discount_price)
                                <h5>Ammount = {{$oi->qty * $oi->cake->discount_price}} </h5>
                                @else
                                <h5>Ammount = {{$oi->qty * $oi->cake->price}} </h5>
                                @endif
                                </div>
                            </div>
                        </div>
